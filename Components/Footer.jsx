...
function Footer() {
  return (
    <footer className="bg-[#27272c] py-6 px-10 font-sans tracking-wide">
  <div className="flex items-center justify-between max-sm:flex-col gap-5">
    <p className="text-lg text-gray-300">Follow us</p>

    <ul className="flex flex-wrap justify-center gap-x-8 gap-4">
      <li>
        <a href="https://bit.ly/40hrLde" className="text-xl hover:text-gray-400" target="_blank" >
          <svg xmlns="http://www.w3.org/2000/svg" className="inline w-7 h-7" viewBox="0 0 512 512">
            ...
            <path fill="#fff" d="M355.65 330 367 256h-71v-48.021c0-20.245 9.918-39.979 41.719-39.979H370v-63s-29.296-5-57.305-5C254.219 100 216 135.44 216 199.6V256h-65v74h65v178.89C93.62 489.69 0 383.78 0 256 0 114.62 114.62 0 256 0s256 114.62 256 256z" />
          </svg>
        </a>
      </li>

      <li>
        <a href="https://bit.ly/48qwIT5" className="text-xl hover:text-gray-400 " target="_blank" >
      ...
      <li>
        <a href="https://bit.ly/4eYzNfr" className="text-xl hover:text-gray-400" target="_blank" >
  ...
  <div className="text-center text-gray-300 mt-4">
    <p>&copy; {new Date().getFullYear()} Rizvi Dev. All rights reserved.</p>
  </div>
</footer>
