...
import { useRouter } from 'next/router'; // Import useRouter at the top of your component
          ...
          <div className="order-2 md:order-2 relative flex justify-center items-center">
            <div className="overflow-hidden">
              <img 
                ...
                className="overflow-hidden w-full h-full object-contain rounded-full myimg" 
                alt="Ahmad Hassan" 
              />
            </div>            
